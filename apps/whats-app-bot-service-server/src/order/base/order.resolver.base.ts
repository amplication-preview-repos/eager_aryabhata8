...
import { DigitalProduct } from "../../digitalProduct/base/DigitalProduct";
...
export class OrderResolverBase {
  ...
  async createOrder(@graphql.Args() args: CreateOrderArgs): Promise<Order> {
    return await this.service.createOrder({
      ...
      data: {
        ...
        digitalProduct: args.data.digitalProduct
          ? {
              connect: args.data.digitalProduct,
            }
          : undefined,
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => DigitalProduct, {
    nullable: true,
    name: "digitalProduct",
  })
  @nestAccessControl.UseRoles({
  ...
  async getDigitalProduct(
    ...
    const result = await this.service.getDigitalProduct(parent.id);
